...
<div x-data="dropdown()" x-init="loadOptions()" class="w-full md:w-1/2 flex flex-col items-center h-64 mx-auto" wire:ignore.self>
    <input name="values" type="hidden" x-bind:value="selectedValues()">
    <input type="text" wire:model="roles_id" value="">

    <div class="inline-block relative w-64">
        <div class="flex flex-col items-center relative">
            <div x-on:click="open" class="w-full">
                <div class="my-2 p-1 flex border-2 border-gray-200 bg-white rounded ">
